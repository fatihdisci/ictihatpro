// Daire kısa kodları saidsurucu/yargi-cli projesindeki MIT lisanslı eşlemeden uyarlanmıştır.
// Ayrıntılı atıf için THIRD_PARTY_NOTICES.md dosyasına bakın.
export const CHAMBER_CODES: Record<string, string> = {
  H1: "1. Hukuk Dairesi",
  H2: "2. Hukuk Dairesi",
  H3: "3. Hukuk Dairesi",
  H4: "4. Hukuk Dairesi",
...
export function resolveChamber(value: string | undefined): string | undefined {
  const chamber = value?.trim();
  if (!chamber) return undefined;
  return CHAMBER_CODES[chamber.toUpperCase()] ?? chamber;
}
